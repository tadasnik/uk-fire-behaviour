...
>
	...
	/** Provide arbitrary classes to the trigger button region in active state. */
	export let regionControlActive: CssClasses = '';
	...
	setContext('regionControlActive', regionControlActive);
