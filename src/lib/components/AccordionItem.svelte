<script lang="ts">
	...
	// ---
	/** Provide arbitrary classes to the trigger button region. */
	export let regionControlActive: CssClasses = getContext('regionControlActive');
	/** Provide arbitrary classes to the trigger button region. */
	...
	export let transitionOutParams: TransitionParams<TransitionOut> =
		getContext('transitionOutParams');
	...
	$: classesRegionState = openState ? regionControlActive : regionControl;
	$: classesControl = `${cControl} ${padding} ${hover} ${rounded} ${classesRegionState}`;
	...
	$: console.log(classesRegionState, regionControl, regionControlActive, openState);
</script>
